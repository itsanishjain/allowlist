        ...
        <div class="container items-center max-w-6xl px-8 mx-auto xl:px-5">
          <div class="flex flex-wrap items-center sm:-mx-3">
            <div class="w-full md:w-1/2 md:px-3">
              <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-7 sm:pr-5 lg:pr-0 md:pb-0">
                <h1 class="text-4xl font-extrabold tracking-tight text-gray-900 sm:text-5xl md:text-4xl lg:text-5xl xl:text-6xl">
                  <span class="block xl:inline">LoL HeHeHe</span>
                  <br />
                ...
                <div class="relative flex flex-col sm:flex-row sm:space-x-4">
                  <a
                    href="#_"
                    class="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-purple-500 rounded-md sm:mb-0 hover:bg-purple-700 sm:w-auto"
                  >
                    Try It Free
                    <svg
            ...
            <div class="w-full md:w-1/2">
              <div class="w-full h-auto overflow-hidden object-cover rounded-md shadow-xl sm:rounded-xl">
          ...
          <div class="box-border order-first w-full text-black border-solid md:w-1/2 md:pl-10 md:order-none">
            ...
            <ul class="p-0 m-0 leading-6 border-0 border-gray-300">
              <li class="box-border relative py-1 pl-0 text-left text-gray-500 border-solid">
                <span class="inline-flex items-center justify-center w-6 h-6 mr-2 text-white bg-purple-500 rounded-full">
          ...
          <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
              <div class="flex flex-col items-center justify-center p-10">
                <Image class="w-32 h-32 mb-6 rounded-full" src={avtar1} />
                <h2 class="text-lg font-medium">Anish Jain</h2>
                <p class="font-medium text-blue-500">Backend Dev and Founder</p>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
              <div class="flex flex-col items-center justify-center p-10">
                <Image class="w-32 h-32 mb-6 rounded-full" src={avtar2} />
                <h2 class="text-lg font-medium">Ayush Gupta</h2>
                <p class="font-medium text-blue-500">Backend Dev and Manager</p>
                <p class="text-gray-400">
                  HeHe 19 and know something cool about web3
                </p>
              </div>
            ...
            <div class="w-full border border-gray-200 rounded-lg shadow-sm">
              <div class="flex flex-col items-center justify-center p-10">
                <Image class="w-32 h-32 mb-6 rounded-full" src={avtar3} />
                <h2 class="text-lg font-medium">Rachit Hooda</h2>
                <p class="font-medium text-blue-500">Frontend and 😇</p>
                <p class="text-gray-400">
                  Hah in 9th but know so many things : L
                </p>
              </div>

              <div class="flex border-t border-gray-200 divide-x divide-gray-200">
                <a
                  href="https://twitter.com/age_coder"
                  class="flex-1 block p-5 text-center text-gray-300 transition duration-200 ease-out hover:bg-gray-100 hover:text-gray-500"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <a
                  href="https://github.com/Rachit-hooda-18"
                  class="flex-1 block p-5 text-center text-gray-300 transition duration-200 ease-out hover:bg-gray-100 hover:text-gray-500"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
